...
const LOCAL_CONTENT: Record<Language, any> = {
  [Language.ENGLISH]: {
    ...
    contactSub: "Available for consulting and high-impact AI architecture projects."
  },
  [Language.JAPANESE]: {
    contactTitle: "共に創り上げましょう",
    contactSub: "コンサルティングやインパクトの大きいAIアーキテクチャ設計を承ります。"
  },
  [Language.CHINESE]: {
    contactTitle: "让我们共同协作",
    contactSub: "可承接咨询和高影响力的 AI 架构项目。"
  },
  [Language.KOREAN]: {
    contactTitle: "함께 비즈니스를 구축합시다",
    contactSub: "컨설팅 및 고성능 AI 아키텍처 프로젝트 협업 가능。"
  }
};
  ...
  return (
    <section className="w-full max-w-4xl mt-16 mb-8 px-6 py-10 bg-gradient-to-br from-indigo-900/20 to-blue-900/20 border border-slate-700/50 rounded-3xl backdrop-blur-md flex flex-col md:flex-row items-center justify-between gap-8">
      <div className="text-center md:text-left">
        <h3 className="text-2xl font-bold text-white mb-2">{t.contactTitle}</h3>
